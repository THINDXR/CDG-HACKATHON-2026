...
window.Icons = (function () {
  const PATHS = {
    ...
    /* ---------- ยานพาหนะ / ตัวควบคุมแผนที่ ---------- */

    // รถยนต์ — ตัวถังเตี้ยกว่าไอคอน accident เพื่อให้แยกออกจากกันตอนวางคู่กัน
    car:
      '<path d="M3.5 15.5l1.3-4.4A2.3 2.3 0 0 1 7 9.5h10a2.3 2.3 0 0 1 2.2 1.6l1.3 4.4"/>' +
      '<path d="M2.8 15.5h18.4v2.6a1 1 0 0 1-1 1h-1.6a1 1 0 0 1-1-1v-1.2H6.4v1.2a1 1 0 0 1-1 1H3.8a1 1 0 0 1-1-1z"/>' +
      '<path d="M6.6 12.6h2.2M15.2 12.6h2.2"/>',

    motorbike:
      '<circle cx="5.2" cy="16.8" r="3.2"/><circle cx="18.8" cy="16.8" r="3.2"/>' +
      '<path d="M5.2 16.8h5l4-6.4h3.2"/><path d="M14.2 10.4l2.4 6.4"/>' +
      '<path d="M12.6 6.6h3.2l1.4 2.2"/>',
    ...
    // มาตรวัดความเร็ว — ใช้บนการ์ดนำทาง
    speed:
      '<path d="M4 17.5a9 9 0 1 1 16 0"/>' +
      '<path d="M12 14.2l3.6-4.4"/><circle cx="12" cy="15.4" r="1.3"/>',
    ...
    trendDown:
      '<path d="M3.5 7l6.4 6.4 3.4-3.4L20.5 17"/>' +
      '<path d="M20.5 12.2V17h-4.8"/>',

    route:
      '<circle cx="6" cy="6" r="2.6"/><circle cx="18" cy="18" r="2.6"/>' +
      '<path d="M6 8.6v4.2a3.4 3.4 0 0 0 3.4 3.4h5.2"/>',
  };
